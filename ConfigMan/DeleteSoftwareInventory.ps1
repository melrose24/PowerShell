...
Invoke-Command -ComputerName $DeviceName -Scriptblock {Invoke-WMIMethod -NameSpace  root\ccm -Class SMS_Client -Name TriggerSchedule "{00000000-0000-0000-0000-000000000002}"}
