...
Invoke-Command  $ComputerName  -ScriptBlock 
    ...
    Write-Host $_.$guid
        If ($guid) 
        {
            ...
            Start-Process -FilePath 'c:\windows\CCMSETUP\ccmsetup.exe' -ArgumentList '/forceinstall cminstalldir=c:\windows\ccm ccmloglevel=0 cclogmaxsize=5242880 disablesiteopt=true DisableCache0pt=True smscachedir=c:\prod\WSD smscachesize=25 smscacheflags=PERCENTDISKSPACE SMSSITECODE=Auto' -Wait 
        }
    }
}
